...
It requires __buffering__ messages (e.g. B) when necesery, and __ommiting__ timer ticks (e.g. 4) in case there were no messages to consume, current or buffered.
